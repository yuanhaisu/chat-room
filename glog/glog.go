...
func InfolnWithTrace(context context.Context, args ...interface{}) {
	logging.println(infoLog, "trace_id:", context.Value("trace_id"), args)
}
...
func WarninglnWithTrace(context context.Context, args ...interface{}) {
	logging.println(warningLog, "trace_id:", context.Value("trace_id"), args)
}
...
func WarningfWithTrace(context context.Context, args ...interface{}) {
	logging.printf(warningLog, "trace_id:", context.Value("trace_id"), args)
}
...
func ErrorWithTrace(context context.Context, args ...interface{}) {
	logging.println(errorLog, "trace_id:", context.Value("trace_id"), args)
}
